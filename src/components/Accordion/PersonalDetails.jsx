  ...
  return (
    <Accordion.Item eventKey="0">
      <Accordion.Header className="btn-choose constainer-header-accordion">
        <button
          className="ml-5 w-100 d-flex justify-content-between align-items-center"
          type="button"
        >
      ...
      <Accordion.Body className="cursor-pointer">
        <div className="accordion-body my-2 p-2 border border-secondary rounded">
          <div className="d-flex my-4 ">
            ...
            <div className="my-auto">
              <div className="d-flex">
                <div className="mx-2">
                  <label className="label-form-choose" for="Givenname">
                    {t("givenname")}
                  </label>
                  <input
                ...
                <div className="mx-2">
                  <label className="label-form-choose" for="Familyname">
                    {t("familyname")}
                  </label>
                  <input
              ...
              <div className="m-2">
                <label className="label-form-choose W-100" for="Emailaddress">
                  {t("emailaddress")}
                </label>
                <input
                  className="input-form-choose w-100"
          ...
          <div className="mx-2">
            <label className="label-form-choose" for="headline">
              {t("headline")}
            </label>
            <input
              className="input-form-choose w-100"
          ...
          <div className="mx-2">
            <label className="label-form-choose" for="phonenumber">
              {t("phonenumber")}
            </label>
            <input
          ...
          <div className="mx-2">
            <label className="label-form-choose" for="address">
              {t("address")}
            </label>
            <input
          ...
          <div className="d-flex">
            <div className="w-50">
              <label className="label-form-choose" for="postcode">
                {t("postcode")}
              </label>
              <input
