    ...
    <Accordion.Item eventKey="1">
      ...
      <Accordion.Body className="cursor-pointer" >
        <div className=" my-2 p-3 py-4 border border-secondary rounded">
          <div className="my-2">
            <label className="label-form-choose" for="Education">
              {t("education")}
            </label>
            <input
          ...
          <div className="d-flex">
            <div className="my-2">
              <label className="label-form-choose" for="school">
                {t("school")}
              </label>
              <input
          ...
          <div className="d-flex">
            <div className="my-2 w-50">
              ...
              >
                ...
                <option value={t("September")}>{t("September")}</option>
                <option value={t("October")}>{t("October")}</option>
