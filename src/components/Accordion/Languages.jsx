    ...
    <Accordion.Item eventKey="4">
      <Accordion.Header className="btn-choose constainer-header-accordion">
        ...
        >
          ...
          }} value={languages.title} className="border-0" type="text" />
      ...
      <Accordion.Body className="cursor-pointer">
          {languages.language.map((language,index) => (
            <div className="my-2 p-3 py-4 border border-secondary rounded">
              <div className="my-2">
                <label className="label-form-choose" for="Languages">
                  {t("Language")}
                </label>
                <input
              ...
              <div>
                ...
                <div className="d-flex  flex-row-reverse mt-3">
                  <button className="btn-add hvr-sweep-to-left">
                    {t("save")}
                  </button>
                  <svg
        ...
        <button type="button" onClick={addLanguage} className="border border-secondary p-2 bg-white rounded">
